                                            ...
                                            std::vector<float>& interleaved)
{
    ...
    interleaved.assign(static_cast<std::size_t>(safe_frame_count) *
    ...
    for (int frame = 0; frame < safe_frame_count; ++frame) {
        interleaved[static_cast<std::size_t>(frame) * static_cast<std::size_t>(safe_channel_count)] =
            input_channels[0][frame];
    }
}
