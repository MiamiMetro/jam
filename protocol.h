...
constexpr size_t DEFAULT_OPUS_JITTER_PACKETS = 3; // Default steady-state Opus playout floor
constexpr size_t DEFAULT_OPUS_AUTO_START_JITTER_PACKETS = 4; // Initial adaptive internet cushion
constexpr size_t DEFAULT_OPUS_AUTO_MAX_JITTER_PACKETS = 8; // Default adaptive jitter ceiling
